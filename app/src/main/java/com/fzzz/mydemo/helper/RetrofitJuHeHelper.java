 ...
 * update:
 */
public class RetrofitJuHeHelper {
    private static RemoteService remoteService;

    private RetrofitJuHeHelper() {
    ...
    public static RemoteService get() {
        if (null == remoteService) {
            synchronized (RetrofitJuHeHelper.class) {
                if (null == remoteService) {
                    new RetrofitJuHeHelper();
                }
            }
        }
        return RetrofitJuHeHelper.remoteService;
    }
